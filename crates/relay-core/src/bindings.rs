...
pub fn type_collection() -> Types {
    Types::default()
        ...
        .register::<crate::engine::TransferItem>()
        ...
        .register::<crate::settings::LaunchMode>()
        ...
        .register::<crate::workspace::Workspace>()
        .register::<crate::workspace::WorkspaceTab>()
